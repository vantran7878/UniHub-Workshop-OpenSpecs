...
C4Container
  ...
  System_Boundary(unihub, "UniHub Workshop") {
    ...
    Container(mobile_app, "Mobile App", "React Native", "Quét QR, hỗ trợ check-in offline với local SQLite, sinh viên sử dụng để xem workshop, nhận thông báo")
  ...
  Rel(student, mobile_app, "Đăng ký workshop, nhận thông báo ", "HTTPS")
