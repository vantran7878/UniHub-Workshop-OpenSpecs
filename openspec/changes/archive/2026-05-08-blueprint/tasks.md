...
## 12. Web app (Next.js - Admin & Student)

- [x] 12.1 Scaffold Next.js app with authentication (login/logout/register)
- [x] 12.2 Implement Student Dashboard: workshop list, details, registration with QR display
- [x] 12.3 Implement Admin Dashboard: workshop management (CRUD), PDF upload, and statistics

## 13. Mobile App (Flutter - Staff Check-in)

- [x] 13.1 Scaffold Flutter app with staff authentication
- [x] 13.2 Implement QR Scanner with Online/Offline dual mode
- [x] 13.3 Implement Local caching (SQLite) for preload data and unsynced check-ins
- [x] 13.4 Implement Background sync logic for offline records
